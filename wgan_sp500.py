...
Original file is located at
    https://colab.research.google.com/drive/1zoXLx9orZ_Te4Tqvoyur8zkQYbq17HcU
...
plt.savefig("plots/raw_series_of_S&P500 (WGAN).svg", format="svg")
plt.close()
...
# Show the plot
plt.savefig("plots/S&P 500 Index Direct Returns_and_S&P 500 Index Log Returns (WGAN).svg", format="svg")
plt.close()
...
plt.ylabel(r'$\rho$')
plt.grid()
plt.savefig("plots/ACF S&P 500 Log-Returns (WGAN).svg", format="svg")
plt.close()
...
plt.grid()
plt.savefig("plots/ACF S&P 500 Absolute Log-Returns (WGAN).svg", format="svg")
plt.close()
...
plt.ylabel(r'$L(\tau)$')
plt.grid()
plt.savefig("plots/Leverage Effect S&P 500 (WGAN).svg", format="svg")
plt.close()
...
plt.grid(True)
plt.savefig("plots/Q-Q Plot - S&P 500 Log Returns (WGAN).svg", format="svg")
plt.close()
...
plt.ylabel('Sample Quantiles')
plt.grid(True)
plt.savefig("plots/Q-Q Plot - Transformed S&P 500 Log Returns (WGAN).svg", format="svg")
plt.close()
...
plt.ylabel('Sample Quantiles')
plt.grid(True)
plt.savefig("plots/Q-Q Plot - Reversed pre-processed S&P 500 Log Returns (WGAN).svg", format="svg")
plt.close()
